module hash_bucket_array_shadow #(
    ...
    input wire [BUCKET_AW-1:0] a_addr,
    input  wire                   en0_a,
    input  wire                   en1_a,
    input  wire                   en2_a,
    input  wire                   en3_a,
