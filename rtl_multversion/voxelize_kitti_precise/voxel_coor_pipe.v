...
`endif
    ...
    wire signed [PT_WIDTH_XY-1:0] point_x_fix20_voxel;
    wire signed [PT_WIDTH_XY-1:0] point_y_fix20_voxel;
    ...
    float_to_fixed_voxel_ceil #(
        .FIXED_WIDTH     (PT_WIDTH_XY),
        .FIXED_FRACTIONAL(PT_WIDTH_F_XY)
    ) u_float2fxp_x_voxel (
        .float_in        (point_x_float32),
        .true_fixed_value(point_x_fix20_voxel),
        .fixed_sign      ()
    );
    ...
    float_to_fixed_voxel_ceil #(
        ...
        .float_in        (point_y_float32),
        .true_fixed_value(point_y_fix20_voxel),
        .fixed_sign      ()
    );
    ...
    fxp_add #(
        ...
        .ina     (point_y_fix20_voxel),
        .inb     (THRESHOLD_BOUDARY_Y_CEIL_FIX),
