module pfe #(
    ...
    parameter integer BRAM_DATA_WIDTH = 504,  // 72bit * 7 points per row
    ...
    assign temp_sub_voxel_x = temp_mult_voxel_x + COEFF_OFFSET_X;  // 
    assign temp_sub_voxel_y = temp_mult_voxel_y - COEFF_OFFSET_Y;
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            if (st3_to_st4) begin
                ...
                // QI.F
                st4_mean_x   <= temp_mult_x[16-PT_WIDTH_F_XY+PT_WIDTH_XY-1:16-PT_WIDTH_F_XY];
                st4_mean_y   <= temp_mult_y[16-PT_WIDTH_F_XY+PT_WIDTH_XY-1:16-PT_WIDTH_F_XY];
                st4_mean_z   <= temp_mult_z[16-PT_WIDTH_F_Z+PT_WIDTH_Z-1:16-PT_WIDTH_F_Z];

                st4_vx_fixxy <= temp_sub_voxel_x[16-PT_WIDTH_F_XY+PT_WIDTH_XY-1:16-PT_WIDTH_F_XY];
                st4_vy_fixxy <= temp_sub_voxel_y[16-PT_WIDTH_F_XY+PT_WIDTH_XY-1:16-PT_WIDTH_F_XY];
