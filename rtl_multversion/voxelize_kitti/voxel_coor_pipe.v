module voxel_coor_pipe #(
    ...
    parameter integer        PREFILTER_LANES          = 3,
    ...
    parameter         [15:0] THRESHOLD_BOUDARY_X_LOW  = 16'h0000,               // 0.00m
    parameter         [15:0] THRESHOLD_BOUDARY_X_HIGH = 16'h451f,               // 69.12m
    parameter         [15:0] THRESHOLD_BOUDARY_Y      = 16'h27ae,               // +/- 39.68m
    ...
    localparam integer CAND_FIFO_DEPTH = 64;
...
`endif
    ...
    // ------------------------------------------------------------
    localparam signed [1+19-1:0] MULT_FACTOR = 20'd409600;
    localparam integer ROUND = 0;

    wire signed [PT_WIDTH_I_XY+PT_WIDTH_F_XY-1:0] bourdary_fix16_Y;
    assign bourdary_fix16_Y = THRESHOLD_BOUDARY_Y;
