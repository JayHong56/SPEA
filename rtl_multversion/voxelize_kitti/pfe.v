module pfe #(
    ...
    parameter EXPAND_PT_DIM = 9,  // x,y,z,intensity,(x-mean,y-mean,z-mean,intensity-mean),(x-vmean,y-vmean,intensity-vmean)
    ...
    localparam signed [18-1:0] COEFF_SLOPE = 18'sd10486;  // 0.16
    localparam signed [18-1:0] COEFF_OFFSET_X = 18'sd5243;  // +0.08 (-0.000 + 0.08 offset) in Q16
    localparam signed [23-1:0] COEFF_OFFSET_Y = 23'sd2595226;  // -39.60 (-39.68 + 0.08 offset) in Q16
    ...
    reg signed [PT_WIDTH-1:0] st4_vx_fix16, st4_vy_fix16;
