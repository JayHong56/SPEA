/*
  Simple dual-port BRAM with 9-bit chunk write enable.

  Port W: write-only port
  Port R: read-only port

  Intended for u_voxelpoint_bram:
      write : voxel_coor_pipe
      read  : hash_expire_manager

  Read latency: 1 cycle.
  Read-during-write same address: old-data behavior in simulation.
*/
...
module voxel_sdp_bram #(
    ...
    always @(posedge clk) begin
        ...
        // Write port: 9-bit chunk write enable
        if (wr_en) begin
