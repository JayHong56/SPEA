...
// s2mm_clear_mux_1dm
// ---------------------------------------------------------------
// Put this mux directly before ONE AXI DataMover S2MM channel.
// During clear_busy=1, the DataMover receives the zero-clear command/data
// from s2mm_clear_writer. During clear_busy=0, the DataMover receives the
// normal scatter command/data path.
//
// The S2MM status stream is also routed. If you do not use normal status,
// tie normal_sts_tready to 1'b1 so DataMover status will not block during
// normal scatter writes.
// ================================================================
module s2mm_clear_mux_1dm #(
    ...
    // ---------------- Clear path from s2mm_clear_writer ----------------
    ...
    // ---------------- From AXI DataMover S2MM status ----------------
