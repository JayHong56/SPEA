...
// ================================================================
// s2mm_normal_drain_monitor
// ---------------------------------------------------------------
// Pass-through monitor for one AXI DataMover S2MM normal write lane.
// It does not modify command/data payloads. It only counts accepted
// S2MM commands and returned S2MM status packets so the top-level
// controller can know when this output write lane is truly drained.
// ================================================================
