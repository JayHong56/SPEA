...
module voxelize #(
    ...
    parameter integer BRAM_ADDR_WIDTH_PFE = 7,  // HASH_VOXEL_NUMBER(64) * 4brams
    parameter MEM_WEIGHT_FILE = "E:\\verilog\\board\\.parameters\\pfn_weight.mem",
    parameter MEM_BIAS_FILE = "E:\\verilog\\board\\.parameters\\bias.mem"
    ...
    localparam integer MEM_FILE_LENGTH = 173600;
    ...
    // voxel_scatter_addr_gen u_voxel_scatter_addr_gen (
    //     .aclk             (clk_p),
    //     .aresetn          (rst_n),
