module pfn_layer #(
    ...
    localparam signed [16-1:0] DEQUANT_MUL = 16'sd779;  // 3482 = round(2^28 / 77089.47481872393)，其中 256 是量化后的小数放大倍数 (Q8.8)
...
`ifndef SYNTHESIS
    ...
    always @(posedge clk) begin
        if (rst_n && s_axis_pfe_valid && s_axis_pfe_tready) begin
            ...
            // end
            // 88 88 412 115 88 88 412 88 88 
            // 8  7  6 5 4   3   2   1  0
            // vx vy z i x-m y-m z-m vx vy
            if (pfe_csv_fd != 0) begin
