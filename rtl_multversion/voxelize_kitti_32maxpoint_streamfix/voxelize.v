...
module voxelize #(
    ...
    wire [AXIS_DATA_WIDTH-1:0] m_axis_pfn_data;
    wire m_axis_pfn_last;
    ...
    pfn_layer #(
        ...
        .ACC_WIDTH         (ACC_WIDTH),
        .AXIS_OUT_WIDTH    (AXIS_DATA_WIDTH),
        .MAX_VOXEL_NUM     (MAX_VOXEL_NUM)
    ) u_pfn_layer (
        .clk                   (clk_p),
        .rst_n                 (rst_n),
        ...
        .m_axis_pfn_last       (m_axis_pfn_last),
    ...
    wire pfn0_in_valid;
    wire pfn0_in_ready;
    wire [AXIS_DATA_WIDTH-1:0] pfn0_in_data;
    wire pfn0_in_last;

    wire pfn1_in_valid;
    wire pfn1_in_ready;
    wire [AXIS_DATA_WIDTH-1:0] pfn1_in_data;
    wire pfn1_in_last;
    ...
    pfn_dual_widthconv_router #(
        .PFN_DATA_WIDTH(AXIS_DATA_WIDTH),
        .COORD_WIDTH   (COORD_WIDTH)
        ...
        .s_axis_pfn_tlast  (m_axis_pfn_last),
        ...
        .m0_axis_pfn_tlast (pfn0_in_last),
        ...
        .m1_axis_pfn_tlast (pfn1_in_last),
    ...
    // PFN already emits 128-bit packet beats. Do not pass it through the old
    // 1024-to-128 width converters again, otherwise each PFN beat is expanded
    // into a fake 8-beat packet.
    ...
    assign pfn0_in_ready    = conv0_out_tready;
    assign conv0_out_tvalid = pfn0_in_valid;
    assign conv0_out_tdata  = pfn0_in_data;
    assign conv0_out_tlast  = pfn0_in_last;

    assign pfn1_in_ready    = conv1_out_tready;
    assign conv1_out_tvalid = pfn1_in_valid;
    assign conv1_out_tdata  = pfn1_in_data;
    assign conv1_out_tlast  = pfn1_in_last;
